    ...
    <footer className="bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">TechMission Rio</h2>
          ...
          <div>
            <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Links Rápidos</h2>
          ...
          <div>
            <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Redes Sociais</h2>
